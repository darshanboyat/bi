                    ...
                    blogstype.map((el) => (
                        <div key={el.id} className="snap-start flex flex-col space-y-4">
                            ...
                            <div className='w-96 ml-4'>
                                ...
                                <p className='Gilroy-light text-gray-400 text-sm pb-6'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
