...
const OpeningJob = [
  {
    ...
    description: "React Native, ReactJs, Redux, SDK Integration, JS, and Hybrid app development, Javascript, ES6, TypeScript, Knowledge of Android or IOS",
    roles: [
...

  {
    ...
    description: "JavaScript, React.js, Redux, Node.js,Vue.js, angular,mongoDB, Express.js, Loopback.js, GitLab, GitHub, Bitbucket, Flux, JSON, HTML, CSS, JSX, ES6, Babel, Webpack, NPM",
    roles: [
  ...
  },
  {
    ...
    JobId: "BI2022-004",
    Experience: "1 to 5 Years",
    description: "MongoDB, Angular, Expressjs, Node.js, HTML, JavaScript, jQuery, CSS",
    roles: [
      "Developing and maintaining all server-side network components",
      "Ensuring optimal performance of the central database and responsiveness to front-end requests",
      "Collaborating with front-end developers on the integration of elements",
  ...
  },
  {
    ...
    JobId: "BI2022-005",
    Experience: "1 to 5 Years",
    description: "MEAN / MERN Stack, Node, React/ Angular, HTML, JavaScript, jQuery, CSS",
    roles: [
  ...
  },
  {
    ...
    Experience: "1 to 5 Years",
    JobId: "BI2022-006",
    description: "Data Analysis, Content Creation, SEO & SEM, CRM, Communication Skills, Social Media, Basic Design Skills",
    roles: [
  ...
  },
  {
    ...
    JobId: "BI2022-007",
    Experience: "1 to 5 Years",
    description: "MongoDB, Expressjs, Reactjs, Node.js, HTML, JavaScript, jQuery, CSS",
    roles: [
      "Developing and maintaining all server-side network components",
      "Ensuring optimal performance of the central database and responsiveness to front-end requests",
      "Collaborating with front-end developers on the integration of elements",
  ...
  },
  {
    ...
    JobId: "BI2022-009",
    Experience: "1 to 5 Years",
    description: "Communication and Interpersonal skills, Collaboration skills, Negotiation and Persuasion skills, Project Management Skills, Research & Strategy, and Business Intelligence.",
    roles: [
  ...
  },
  {
    ...
    Position: "2",
    JobId: "BI2022-0010",
    description: "JavaScript, Blockchain architecture, Cryptography, Data structures, Smart contracts, Web Development.",
    Experience: "1 to 5 Years",
    roles: [
