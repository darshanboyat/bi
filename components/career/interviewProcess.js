        ...
        <div className='2xl:space-y-8 space-y-6 pt-12 pb-12'>
            <div className='grid grid-cols-4'>
                <div className='bg-hr-color'>
                    ...
                    <p className='color-light'>Selection of any candidate is purely depended on their performance in the interview process. Generally, there are three stages in the interview process which are as follows.</p>
                    </div>
                </div>
