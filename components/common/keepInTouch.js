    ...
    return (
        <div className="p-10 grid lg:grid-cols-2 grid-cols-1">
            <div className="flex flex-col space-y-8">
                ...
                <h2 className="2xl:text-6xl lg:text-5xl text-4xl Gilroy-Bold leading-normal w-4/5">Have an idea? <br /> Get in touch, we’d be <br/> happy to hear from you</h2>
                <p className="2xl:text-2xl text-xl Gilroy-Light leading-normal w-4/5">We are always looking out for new collaborations, whether you are a client who is passionate about a project or a talent who is interested in joining our team, our doors are always open.</p>
            </div>
            <div className="flex justify-end">
                <div className="flex flex-col space-y-8 pt-20 w-4/5">
