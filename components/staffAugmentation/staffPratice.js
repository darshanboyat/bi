          ...
          <div className='mt-8 flex'>
              <div className='w-[80%] pr-10'>
                 ...
                 <ul className='mt-4 ml-4'>
                    ...
                    <li className='Gilroy-Medium text-sm mb-2 list-disc'>Transparent and proactive</li>
                 </ul>
              </div>
              <div >
              <div className='grid grid-cols-2 gap-4 '>
                 ...
                 <div className='p-section'>
                    ...
                    <p className='color-light Gilroy-Light text-sm pt-2'>We understand and support the dynamics of a growing startup.</p>
                 </div>
                 <div className='p-section'>
                    <h2 className='Gilroy-Bold text-xl'>No Bond</h2>
                    <p className='color-light Gilroy-Light text-sm pt-2'>Brain Inventory Values Trust More than a Bond. Grow Limitless with Us.</p>
                 </div>
                 <div className='p-section'>
                    <h2 className='Gilroy-Bold text-xl'>Trackability</h2>
                    <p className='color-light Gilroy-Light text-sm pt-2'>Track resource time and tasks using sophisticated tools</p>
                 </div>
                 <div className='p-section'>
                    <h2 className='Gilroy-Bold text-xl'>Communication</h2>
                    <p className='color-light Gilroy-Light text-sm pt-2'>Timely and transparent communication makes us the most dependable partner.</p>
                 </div>
                 <div className='p-section'>
                    <h2 className='Gilroy-Bold text-xl'>Account Manager</h2>
                    <p className='color-light Gilroy-Light text-sm pt-2'>Each client is assigned an Account Manager for all query resolution ensuring a single point of contact.</p>
                 </div>
              </div>
              </div>
          </div>
