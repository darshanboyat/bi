        ...
        return (
            ...
            <div className="container">
                <div>
                    ...
                    <h3 className="Gilroy-Bold text-4xl pb-0">we design visually stunning & user-friendly <br/> customer experience.</h3>
                ...
                <div>
                  <ul>
                    <li className="inline-flex w-full items-center align-middle text-base leading-[34px] color-light">
                      <img src="/images/BulletIcon.png" className="h-2 mr-2" />
