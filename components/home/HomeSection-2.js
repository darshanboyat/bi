    ...
    return (
        <div className="relative">
            <div className="min-h-screen w-full flex flex-col relative overflow-x-hidden bg-gradient-2">
                <p className="text-7xl Gilroy-Bold mt-52 px-10">the new standard in the <br /> web design</p>
            ...
            <div className="min-h-screen relative flex items-center bg-gradient-3">
                ...
                <div className="w-1/3 p-8 flex flex-col items-center">
                    <div className="flex flex-col space-y-8">
                        <p className="text-7xl Gilroy-Bold">our work <br /> speaks about <br /> our company</p>
                        <p className="text-2xl w-3/4">Lorem Ipsem is a dummy text of printing and typesetting settings.</p>
