...
const HomeSectionSeven = () => {
    ...
    return (
        <div>
            <BigHeadingScroll text={'Design interaction betweens humans and brands.'} />
            <p className="2xl:text-4xl xl:text-3xl text-2xl Gilroy-Light 2xl:leading-relaxed 2xl:p-10 p-8">
            ...
            <p className="2xl:mt-28 mt-20 2xl:text-8xl xl:text-7xl text-6xl 2xl:p-10 p-8 2xl:leading-tight leading-snug">
