...
const HomeSectionSix = () => {
    return (
        <div className="lg:h-screen flex flex-col justify-center ">
                <Marquee duration={25000} background="#fafafa00" reverse={true} height="250px">
                    {
                        array.map((el, index) => (
                ...
                <Marquee duration={20000} background="#fafafa00" height="150px">
                    <div className="flex space-x-10 mr-10 2xl:text-2xl text-xl items-center">
                        <span>We partner on big and small projects with all kinds of clients - from boutique brands to market leaders. We partner on big and small projects with all kinds of clients - from boutique brands to market leaders. We partner on big and small projects with all kinds of clients - from boutique brands to market leaders.</span>
                    </div>
                </Marquee>
        </div>
    )
