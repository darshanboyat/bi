...
const HomeSectionThree = () => {
    return (
        <div className="lg:h-screen lg:flex items-end">
            <div className="w-full  p-6 lg:p-10 pr-0 2xl:pb-16 xl:pb-12 pb-10 2xl:space-y-20 xl:space-y-16 space-y-12">
                ...
                <div className="lg:flex justify-between 2xl:space-y-15 xl:space-y-12 space-y-10">
                    <div className="lg:flex flex-col 2xl:space-y-20 xl:space-y-16 space-y-12">
                    ...
                    <img src='/images/HomeSectionThree.png' className="w-[96%] lg:w-[40%]"></img>
                </div>
            </div>
...
const Box = ({title, summary, color, textColor}) => (
    <div className={'bg-base-'+color+'-1'+' 2xl:p-8 xl:p-6 p-4 h-56 mb-4 lg:h-auto overflow-x-hidden relative group' + ' text-'+ textColor}>
