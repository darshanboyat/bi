  ...
  return (
        ...
        <div className='lg:w-[40%] w-full  md:h-full'>
          <div className='3xl:py-10 2xl:py-6 xl:py-6 2xl:px-14 xl:px-12 px-10 flex flex-col justify-center 2xl:space-y-5 xl:space-y-4 space-y-3 h-full'>
            ...
            <div className='2xl:text-3xl lg:text-3xl text-lg Gilroy-Bold color-gray'>We are__</div>
        
            <div className='flex flex-col w-full px-12 py-4'>
              <div className='text-heading-4 tracking-widest text-2xl'>a digital production company focusing heavily on design & development based in indore. we create products that make people say oh damn!</div>
            </div>
