...
const HomeSectionOne = () => {
  ...
  return (
        ...
        <div className='lg:w-1/2 w-full bg-gradient-1 h-full  relative'>
          ...
          {/* onMouseEnter={() => setMouseExpanded(true)} onMouseLeave={() => setMouseExpanded(false)} */}
          <div  className='absolute bottom-0 3xl:py-10 py-8 2xl:px-14 xl:px-12 px-2 lg:px-10 bg-base-blue-1 flex justify-between w-full text-heading-3 Gilroy-Bold'>
          
              <span className='stroke-text hover-animation'>websites</span>
        
          
              <span className='stroke-text hover-animation'>applications</span>
        
          
              <span className='stroke-text hover-animation'>branding</span>
        
          </div>
        </div>
        <div className='hero-bg-1 w-1/2 h-full lg:block hidden'>
           <div className="rotating scroll-logo">
