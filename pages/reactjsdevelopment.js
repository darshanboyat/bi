  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Hire the best & vetted ReactJS developers from Brain Inventory. Our ReactJS developers are skilled in pixel UI Design to API Integration. Hire Now"
        />
      </Head>
      {loading ? (
        <Loader />
